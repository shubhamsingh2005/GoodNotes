    ...
    <div className="h-full w-full overflow-y-auto p-6 md:p-12 scrollbar-thin">
      <div className="max-w-3xl mx-auto animate-fade-in-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          {/* Shubham Singh Card */}
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="pt-16 pb-8 px-6 text-center">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-1">Shubham Singh</h2>
              <p className="text-purple-600 font-medium text-sm mb-4">Full Stack Developer</p>
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="flex items-center gap-2 bg-[#0077b5] text-white px-5 py-2 rounded-full font-bold text-sm hover:bg-[#006396] transition-colors shadow-md"
                >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="pt-16 pb-8 px-6 text-center">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-1">Sarbani Deb</h2>
              <p className="text-teal-600 font-medium text-sm mb-4">Computer Science Student</p>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed text-sm">
                Computer Science Student | AI &amp; Software Development | Tech Debater &amp; Problem‑Solver
              </p>
              <div className="flex justify-center">
                <a
                  href="https://www.linkedin.com/in/sarbani-deb-a55194291/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-[#0077b5] text-white px-5 py-2 rounded-full font-bold text-sm hover:bg-[#006396] transition-colors shadow-md"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-50 dark:bg-gray-800/50 p-6 rounded-2xl border border-blue-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Designed and Developed by <strong>Shubham Singh</strong> &amp; <strong>Sarbani Deb</strong>.
              <br />
